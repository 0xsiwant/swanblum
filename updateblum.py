...
while True:
    print(Fore.YELLOW + Style.BRIGHT + f"Ketik 1: ")
    print(Fore.YELLOW + Style.BRIGHT + f"1. [ botBLUM ] TANGGUL")
...
__   ________________________________________________________________   __
  | |                                                                | |  
  | | _____  _    _   _  ____  ____ _   _ _         ____   ___ _____ | |  
  | ||_   _|/ \  | \ | |/ ___|/ ___| | | | |       | __ ) / _ |_   _|| |  
  | |  | | / _ \ |  \| | |  _| |  _| | | | |       |  _ \| | | || |  | |  
  | |  | |/ ___ \| |\  | |_| | |_| | |_| | |___    | |_) | |_| || |  | |  
  | |  |_/_/   \_|_| \_|\____|\____|\___/|_________|____/ \___/ |_|  | |  
  | |                                         |_____|                | |  
__| |________________________________________________________________| |__
__   ________________________________________________________________   __
  | |                                                                | |  
